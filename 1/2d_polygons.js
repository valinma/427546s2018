...
closePolygonButton = document.getElementById('closePolygon'),
clickTimes=0,
imageData,
p = {},
rubberbandRect = {},
...
function drawingLine(xs,ys,xe,ye)
{
    ...
    context.fillRect(xe,ye,5,5);
    var imageData = context.getImageData(xe,ye,5,5);
    k=(ye-ys)/(xe-xs);
    if(xs < xe){
      X_min = xs;
      X_max = xe;
...
closePolygonButton.onclick = function(e){
    drawingLine(x0,y0,p.x,p.y);
    saveDrawingSurface();
};